...
plot_command="plot 'amr_error_order_1' title 'order 1 AMR' with linespoints ps 1.8 lt 1 dt 1 lw 3 pt 9 lc 2, \
	           'amr_error_order_2' title 'order 2 AMR' with linespoints ps 1.6 lt 1 dt 1 lw 3 pt 5 lc 3,  \
	           'amr_error_order_4' title 'order 4 AMR' with linespoints ps 1.8 lt 1 dt 1 lw 3 pt 13 lc 4,  \
	           'amr_error_order_8' title 'order 8 AMR' with linespoints ps 1.6 lt 1 dt 1 lw 3 pt 7 lc 5" 
