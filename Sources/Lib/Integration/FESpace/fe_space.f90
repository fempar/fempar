...
# include "debug.i90"
  ...
  contains
    ...
    procedure, non_overridable, private :: fill_own_dofs_on_vef_component_wise        => fe_accessor_fill_own_dofs_on_vef_component_wise
    ...
    procedure, non_overridable          :: fe_accessor_determine_at_strong_dirichlet_boundary_single_field
    procedure, non_overridable          :: fe_accessor_determine_at_strong_dirichlet_boundary_all_fields
    generic                             :: determine_at_strong_dirichlet_boundary     => fe_accessor_determine_at_strong_dirichlet_boundary_single_field, &
                                                                                         fe_accessor_determine_at_strong_dirichlet_boundary_all_fields 
