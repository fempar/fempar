...
# include "debug.i90"
  ...
  ! The cell predicate is conceived as a polymorphic data-type variable designed to
  ...
  ! in order to give support to this new data-type variable. Particularly, and new optional
  ! input argument ( fe_cell_predicate ) has been added to "fe_cell_iterator_create",
  ! in case of include when the iterator is created, it will take into account
  ! the restrictions defined in the fe_cell_predicate, otherwise, the behavior of the
  ! fe_cell_iterator will be the default behavior (i. e. it will iterate over all cells).
