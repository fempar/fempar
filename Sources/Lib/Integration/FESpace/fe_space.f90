...
# include "debug.i90"
 ...
 public :: fe_object_iterator_t
  ...
  type, extends(standard_l1_coarse_fe_handler_t) :: vector_laplacian_l1_coarse_fe_handler_t
    private
    real(rp), public :: diffusion_inclusion
  contains
  ...
  end type vector_laplacian_l1_coarse_fe_handler_t
  
  public :: p_l1_coarse_fe_handler_t, l1_coarse_fe_handler_t, standard_l1_coarse_fe_handler_t, H1_l1_coarse_fe_handler_t, vector_laplacian_l1_coarse_fe_handler_t
