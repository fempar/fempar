...
#define HAS_DYNAMIC_MEMORY
  ...
  STD_VECTOR_COPY_FROM_STD_VECTOR(type(cell_map_t),cell_map)
  STD_VECTOR_COPY_FROM_INTRINSIC_ARRAY(type(cell_map_t),cell_map)
  STD_VECTOR_SET(type(cell_map_t),cell_map)
  STD_VECTOR_INIT(type(cell_map_t),cell_map)
  ...
  STD_VECTOR_GET_POINTER_SINGLE_ENTRY(type(cell_map_t),cell_map)
