...
module std_vector_facet_maps_names
  use types_names
  use memor_names
  ...
  STD_VECTOR_TYPE(type(facet_maps_t),facet_maps)
    
  public :: std_vector_facet_maps_t
  
contains
  
#define HAS_DYNAMIC_MEMORY
  STD_VECTOR_PUSH_BACK(type(facet_maps_t),facet_maps)
  STD_VECTOR_RESIZE(type(facet_maps_t),facet_maps)
  ...
  STD_VECTOR_COPY_FROM_STD_VECTOR(type(facet_maps_t),facet_maps)
  STD_VECTOR_COPY_FROM_INTRINSIC_ARRAY(type(facet_maps_t),facet_maps)
