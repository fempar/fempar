  ...
  type mesh_t
    ...
    contains
     ...
     ! Coords getters
      ...
      generic                                      :: read_fempar_gid_problem_type_format => mesh_read_fempar_gid_problem_type_format_dir_path_prefix, &
                                                                                             mesh_read_fempar_gid_problem_type_format_pl  , & 
                                                                                             mesh_read_fempar_gid_problem_type_format_file_unit
      
      procedure, non_overridable                   :: mesh_write_fempar_gid_problem_type_format_dir_path_prefix
      procedure, non_overridable                   :: mesh_write_fempar_gid_problem_type_format_pl
      procedure, non_overridable                   :: mesh_write_fempar_gid_problem_type_format_file_unit
      generic                                      :: write_fempar_gid_problem_type_format => mesh_write_fempar_gid_problem_type_format_dir_path_prefix, &
                                                                                    mesh_write_fempar_gid_problem_type_format_pl, &
                                                                                    mesh_write_fempar_gid_problem_type_format_file_unit
      
      procedure, non_overridable                   :: mesh_write_gid_postprocess_format_dir_path_prefix
      procedure, non_overridable                   :: mesh_write_gid_postprocess_format_pl
      procedure, non_overridable                   :: mesh_write_gid_postprocess_format_file_unit
      procedure, non_overridable, private, nopass  :: mesh_gid_postprocess_format_compose_name
      generic                                      :: write_gid_post_process_format => mesh_write_gid_postprocess_format_dir_path_prefix, &
...
contains
  ...
  !=============================================================================
   subroutine mesh_read_fempar_gid_problem_type_format_pl(this, parameter_list)
     ...
     call io_close(lunio)
   end subroutine mesh_read_fempar_gid_problem_type_format_pl
   
  !=============================================================================
  subroutine mesh_read_fempar_gid_problem_type_format_file_unit(this,lunio)
    !------------------------------------------------------------------------
    !
  ...
  end subroutine mesh_read_fempar_gid_problem_type_format_file_unit  
  
  !=============================================================================
   subroutine mesh_read_fempar_gid_problem_type_format_dir_path_prefix (this, dir_path, prefix)
     implicit none 
     class(mesh_t)        , intent(inout) :: this
     ...
     call this%read_fempar_gid_problem_type_format(lunio) 
     call io_close(lunio)
   end subroutine mesh_read_fempar_gid_problem_type_format_dir_path_prefix
  ...
  subroutine mesh_fempar_gid_problem_type_format_compose_name ( prefix, name ) 
   ...
   !=============================================================================
   subroutine mesh_write_fempar_gid_problem_type_format_dir_path_prefix (this, dir_path, prefix)
     implicit none 
     class(mesh_t)        , intent(in) :: this
     character(len=*)     , intent(in) :: dir_path
     character(len=*)     , intent(in) :: prefix
     ...
     call io_close(lunio)
  end subroutine mesh_write_fempar_gid_problem_type_format_dir_path_prefix
   
  !=============================================================================
  subroutine mesh_write_fempar_gid_problem_type_format_pl(this, parameter_list)
     implicit none 
     class(mesh_t)        , intent(out) :: this
     type(ParameterList_t), intent(in)    :: parameter_list
      character(len=:), allocatable   :: name
  ...
  end subroutine mesh_write_fempar_gid_problem_type_format_pl
  
  !=============================================================================
  subroutine mesh_write_fempar_gid_problem_type_format_file_unit (this,lunio)
    implicit none
    class(mesh_t) , intent(in)          :: this
    integer(ip)   , intent(in)          :: lunio
...
!=============================================================================
  ...
  !=============================================================================
  subroutine mesh_write_gid_postprocess_format_file_unit (this,lunio,title)
    !------------------------------------------------------------------------
    !
...
6   format(i6,10(1x,i6))
  ...
  end subroutine mesh_write_gid_postprocess_format_file_unit
  ...
  subroutine mesh_write_files_for_postprocess ( parameter_list, lmesh )
     ...
     do i=nparts, 1, -1  
        ...
        lunio = io_open( trim(dir_path) // '/' // trim(rename), 'write' ); check(lunio>0)
        call lmesh(i)%write_gid_post_process_format(lunio)
        call io_close(lunio)
     end do
  ...
  !=============================================================================
   ...
   !=============================================================================
   subroutine mesh_write_gid_postprocess_format_pl ( f_mesh, parameter_list)
     implicit none 
     ...
     call f_mesh%write_gid_post_process_format(dir_path,name)
   end subroutine mesh_write_gid_postprocess_format_pl
   
   !=============================================================================
   subroutine mesh_write_gid_postprocess_format_dir_path_prefix (f_mesh, dir_path, prefix)
     implicit none 
     class(mesh_t)   , intent(in) :: f_mesh
     character(len=*), intent(in) :: dir_path
     character(len=*), intent(in) :: prefix
     ...
     lunio = io_open( trim(dir_path)//'/'//trim(name), 'write' ); check(lunio>0)
     call f_mesh%write_gid_post_process_format(lunio)
     call io_close(lunio)
   end subroutine mesh_write_gid_postprocess_format_dir_path_prefix
