...
! *************************************************************************
!          
!   Last Modified by:    $Author: amartin $
!   Date:                $Date: 2014/05/22 09:42:30 $
...
!--------------------------------------------------------------------------
  ...
  INTEGER, PARAMETER, PUBLIC :: GID_REAL_K = C_DOUBLE
  INTEGER, PARAMETER, PUBLIC :: GID_INT_K  = C_INT
...
!--------------------------------------------------------------------------
  ...
  PUBLIC :: GiD_MainMatrixComp, GiD_LAComponents
  PUBLIC :: GiD_fMainMatrixComp, GiD_fLAComponents
