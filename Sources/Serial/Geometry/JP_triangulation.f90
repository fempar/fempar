...
!      class(JP_element_topology_iterator_t), allocatable :: element_iterator
...
!         import :: JP_triangulation_t, JP_element_topology_iterator_t
!         implicit none
...
!        elem => trian%element_iterator%current()
!        call elem%create
