...
# include "debug.i90"
  ...
  contains
    procedure          :: allocate_workspace            => icg_allocate_workspace
    procedure          :: free_workspace                => icg_free_workspace
    procedure          :: set_parameters_from_pl        => icg_set_parameters_from_pl
    procedure          :: solve_body                    => icg_solve_body
    procedure          :: supports_stopping_criteria    => icg_supports_stopping_criteria
    procedure          :: get_default_stopping_criteria => icg_get_default_stopping_criteria
...
contains
  ...
  end subroutine icg_allocate_workspace
  
  subroutine icg_free_workspace(this)
    implicit none
    class(icg_t), intent(inout) :: this
    call this%r%free()
    call this%r2%free()
  ...
  subroutine icg_solve_body(this,x)
    implicit none
    class(icg_t), intent(inout) :: this
  ...
  end subroutine icg_solve_body

  function icg_supports_stopping_criteria(this,stopping_criteria)
    implicit none
    class(icg_t), intent(in) :: this
    integer(ip), intent(in) :: stopping_criteria
    logical :: icg_supports_stopping_criteria
    icg_supports_stopping_criteria = (stopping_criteria == res_res .or. & 
  ...
  end function icg_supports_stopping_criteria
  
  function icg_get_default_stopping_criteria(this)
    implicit none
    class(icg_t), intent(in) :: this
    integer(ip) :: icg_get_default_stopping_criteria
    icg_get_default_stopping_criteria = default_icg_stopping_criteria
