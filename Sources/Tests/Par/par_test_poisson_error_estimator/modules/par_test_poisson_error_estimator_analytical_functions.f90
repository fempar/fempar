...
module par_test_poisson_error_estimator_analytical_functions_names
  use fempar_names
...
contains  
  ...
  subroutine analytical_functions_create ( this, parameters )
    implicit none
    class(analytical_functions_t)                  , intent(inout) :: this
    type(par_test_poisson_error_estimator_params_t), intent(in)    :: parameters
    integer(ip) :: istat
    call this%free()
...
end module par_test_poisson_error_estimator_analytical_functions_names
!***************************************************************************************************
