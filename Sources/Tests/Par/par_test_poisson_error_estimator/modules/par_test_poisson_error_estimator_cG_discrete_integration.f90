...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module par_test_poisson_error_estimator_cG_discrete_integration_names
  use fempar_names
...
contains
  ...
  subroutine integrate_galerkin ( this, fe_space, assembler )
    ...
    if ( allocated(shape_gradients) ) then 
...
end module par_test_poisson_error_estimator_cG_discrete_integration_names
