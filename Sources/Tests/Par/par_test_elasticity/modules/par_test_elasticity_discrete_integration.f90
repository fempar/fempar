...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module test_elasticity_discrete_integration_names
  use fempar_names
...
# include "debug.i90"
  ...
  type, extends(discrete_integration_t), abstract :: test_elasticity_discrete_integration_t
     private
     ...
     type(test_elasticity_analytical_functions_t), pointer :: analytical_functions => null()
   ...
   contains
     ...
     procedure :: free => test_elasticity_discrete_integration_free
  end type test_elasticity_discrete_integration_t

  abstract interface
     subroutine  create_interface(this,number_dimensions,analytical_functions)
       import :: test_elasticity_discrete_integration_t, test_elasticity_analytical_functions_t, ip
       implicit none
       class(test_elasticity_discrete_integration_t)       , intent(inout) :: this
       integer(ip)                                   , intent(in)    :: number_dimensions
       type(test_elasticity_analytical_functions_t), target, intent(in)    :: analytical_functions
     end subroutine create_interface
     function is_symmetric_interface(this)
       import :: test_elasticity_discrete_integration_t
       implicit none
       class(test_elasticity_discrete_integration_t)       , intent(inout) :: this
     ...
     subroutine init_solution_interface(this,fe_space,solution)
       import :: test_elasticity_discrete_integration_t, serial_fe_space_t, fe_function_t
       class(test_elasticity_discrete_integration_t)       , intent(inout) :: this
     ...
     !  import :: test_elasticity_discrete_integration_t, serial_fe_space_t
     !  class(test_elasticity_discrete_integration_t)       , intent(inout) :: this
     !  class(serial_fe_space_t)                      , intent(in)    :: fe_space
  ...
  type, extends(test_elasticity_discrete_integration_t) :: irreducible_discrete_integration_t
     private
   contains
  ...
  type, extends(test_elasticity_discrete_integration_t) :: mixed_u_p_discrete_integration_t
     private
   contains
  ...
  public :: test_elasticity_discrete_integration_t, irreducible_discrete_integration_t, mixed_u_p_discrete_integration_t
  public :: discrete_integration_type_irreducible, discrete_integration_type_mixed_u_p
  
contains

  subroutine test_elasticity_discrete_integration_free ( this )
     implicit none
     class(test_elasticity_discrete_integration_t)   ,intent(inout)  :: this
     integer(ip) :: istat
  ...
  end subroutine test_elasticity_discrete_integration_free
  ...
  function get_fe_function (this)
    implicit none
    class(test_elasticity_discrete_integration_t), target, intent(in) :: this
...
!==============================================================================
  ...
  function get_number_fields(this)
    implicit none
    class(test_elasticity_discrete_integration_t), intent(in)   :: this
...
end module test_elasticity_discrete_integration_names
