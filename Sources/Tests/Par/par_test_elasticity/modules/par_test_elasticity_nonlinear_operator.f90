...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module test_elasticity_nonlinear_operator_names
  use fempar_names
...
# include "debug.i90"
  ...
  type, extends(operator_t) :: nonlinear_operator_t
     ...
     class(test_elasticity_discrete_integration_t), pointer :: discrete_integration
...
contains
  ...
  subroutine nonlinear_operator_create(this, residual, rhs_values)
    ...
    class is(test_elasticity_discrete_integration_t)
       this%discrete_integration => discrete_integration
    class default
       mcheck(.false.,'nonlinear operator only works with test_elasticity_discrete_integration')
    end select
 ...
 end module test_elasticity_nonlinear_operator_names
