module test_elasticity_params_names
  use fempar_names
...
#include "debug.i90" 
  ...
  type, extends(parameter_handler_t) :: test_elasticity_params_t
     private
     contains
       procedure :: define_parameters  => test_elasticity_params_define_parameters
  ...
  end type test_elasticity_params_t

  ! Types
  public :: test_elasticity_params_t

contains

  !==================================================================================================
  subroutine test_elasticity_params_define_parameters(this)
    implicit none
    class(test_elasticity_params_t), intent(inout) :: this
    ...
    error = switches%set(key = triangulation_generate_key    , value = '--trinagulation-generate')   ; check(error==0)
  ...
  end subroutine test_elasticity_params_define_parameters

  ! GETTERS *****************************************************************************************
  function get_dir_path(this)
    implicit none
    class(test_elasticity_params_t) , intent(in) :: this
...
end module test_elasticity_params_names
