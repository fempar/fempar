...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module test_elasticity_analytical_functions_names
  use fempar_names
  use test_elasticity_constitutive_models_names
  implicit none
# include "debug.i90"
  private
  ...
  type test_elasticity_analytical_functions_t
     private
   ...
   contains
     procedure :: set_num_dimensions        => test_elasticity_analytical_functions_set_num_dimensions
     procedure :: get_source_term_p         => test_elasticity_analytical_functions_get_source_term_p
     procedure :: get_source_term_u         => test_elasticity_analytical_functions_get_source_term_u
     procedure :: get_solution_function_p   => test_elasticity_analytical_functions_get_solution_function_p
     procedure :: get_solution_function_u   => test_elasticity_analytical_functions_get_solution_function_u
     procedure :: get_zero_function_u       => test_elasticity_analytical_functions_get_zero_function_u
     procedure :: get_zero_function_p       => test_elasticity_analytical_functions_get_zero_function_p
  end type test_elasticity_analytical_functions_t

  public :: test_elasticity_analytical_functions_t
...
contains  
 ...
 !===============================================================================================
  ...
  !===============================================================================================
  subroutine test_elasticity_analytical_functions_set_num_dimensions ( this, num_dimensions )
    implicit none
    class(test_elasticity_analytical_functions_t), intent(inout)    :: this
    integer(ip), intent(in) ::  num_dimensions
  ...
  end subroutine test_elasticity_analytical_functions_set_num_dimensions 
  
  !===============================================================================================
  function test_elasticity_analytical_functions_get_source_term_p ( this )
    implicit none
    class(test_elasticity_analytical_functions_t), target, intent(in)    :: this
    class(scalar_function_t), pointer :: test_elasticity_analytical_functions_get_source_term_p
    test_elasticity_analytical_functions_get_source_term_p => this%source_term_p
  end function test_elasticity_analytical_functions_get_source_term_p

  function test_elasticity_analytical_functions_get_source_term_u ( this )
    implicit none
    class(test_elasticity_analytical_functions_t), target, intent(in)    :: this
    class(vector_function_t), pointer :: test_elasticity_analytical_functions_get_source_term_u
    test_elasticity_analytical_functions_get_source_term_u => this%source_term_u
  end function test_elasticity_analytical_functions_get_source_term_u
  
  !===============================================================================================
  function test_elasticity_analytical_functions_get_solution_function_p ( this )
    implicit none
    class(test_elasticity_analytical_functions_t), target, intent(in)    :: this
    class(scalar_function_t), pointer :: test_elasticity_analytical_functions_get_solution_function_p
    test_elasticity_analytical_functions_get_solution_function_p => this%solution_function_p
  end function test_elasticity_analytical_functions_get_solution_function_p

  function test_elasticity_analytical_functions_get_solution_function_u ( this )
    implicit none
    class(test_elasticity_analytical_functions_t), target, intent(in)    :: this
    class(vector_function_t), pointer :: test_elasticity_analytical_functions_get_solution_function_u
    test_elasticity_analytical_functions_get_solution_function_u => this%solution_function_u
  end function test_elasticity_analytical_functions_get_solution_function_u

  !===============================================================================================

  function test_elasticity_analytical_functions_get_zero_function_u ( this )
    implicit none
    class(test_elasticity_analytical_functions_t), target, intent(in)    :: this
    class(vector_function_t), pointer :: test_elasticity_analytical_functions_get_zero_function_u
    test_elasticity_analytical_functions_get_zero_function_u => this%zero_u
  end function test_elasticity_analytical_functions_get_zero_function_u

  function test_elasticity_analytical_functions_get_zero_function_p ( this )
    implicit none
    class(test_elasticity_analytical_functions_t), target, intent(in)    :: this
    class(scalar_function_t), pointer :: test_elasticity_analytical_functions_get_zero_function_p
    test_elasticity_analytical_functions_get_zero_function_p => this%zero_p
  end function test_elasticity_analytical_functions_get_zero_function_p

end module test_elasticity_analytical_functions_names
!***************************************************************************************************
