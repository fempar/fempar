program par_test_transient_poisson
  use fempar_names
  use par_test_transient_poisson_driver_names
  !$ use omp_lib
  implicit none
  integer(ip) :: i
  type(par_test_transient_poisson_fe_driver_t), save :: test_driver 
  ...
  !$OMP END PARALLEL   
end program par_test_transient_poisson
