...
contains
  ...
  contains
    ...
    function cell_set_id( coord, num_dims, jump, inclusion, nchannel_x_direction, nparts_with_channels,domain_limits,num_cells_x_dir,size_sub_object,nparts)
      implicit none
  ...
  subroutine setup_coarse_fe_handlers(this)
    ...
    if ( this%test_params%get_coarse_fe_handler_type() == pb_bddc ) then
       call this%elasticity_coarse_fe_handler%create(this%parameter_list) 
  ...
  subroutine free(this)
    ...
    if ( this%test_params%get_coarse_fe_handler_type() == pb_bddc ) then
       call this%elasticity_coarse_fe_handler%free() 
    else if (this%test_params%get_coarse_fe_handler_type() == standard_bddc) then
