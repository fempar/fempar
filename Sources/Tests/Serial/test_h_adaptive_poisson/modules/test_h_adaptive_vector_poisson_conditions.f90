...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module test_h_adaptive_vector_poisson_conditions_names
  use fempar_names
...
contains
  ...
  function vector_poisson_conditions_get_num_components(this)
    ...
    vector_poisson_conditions_get_num_components = this%boundary_function%get_num_dims()
...
end module test_h_adaptive_vector_poisson_conditions_names
