...
!  end subroutine check_solution_vector
  ...
  subroutine write_solution(this)
    ...
    if(this%test_params%get_write_solution()) then
        ...
        call vtk_writer%write_to_vtk_file(this%test_params%get_output_handler_dir_path()//this%test_params%get_output_handler_prefix()//'_boundary_normals.vtu')
        call vtk_writer%free()

        ! Write the unfitted mesh
        call vtk_writer%attach_fitted_faces(this%triangulation)
        call vtk_writer%write_to_vtk_file(this%test_params%get_output_handler_dir_path()//this%test_params%get_output_handler_prefix()//'_fitted_facets.vtu')
        call vtk_writer%free()

        ! Write the unfitted mesh
        call vtk_writer%attach_facets_quadrature_points(this%fe_space)
        call vtk_writer%write_to_vtk_file(this%test_params%get_output_handler_dir_path()//this%test_params%get_output_handler_prefix()//'_fitted_normals.vtu')
        call vtk_writer%free()
  ...
  subroutine write_filling_curve(this)
    ...
    if(this%test_params%get_write_solution()) then
      ...
      E_IO = VTK_INI_XML(output_format = 'ascii',&
                              filename = this%test_params%get_output_handler_dir_path()//this%test_params%get_output_handler_prefix()//'_filling_curve.vtu',&
