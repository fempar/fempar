...
contains
  ...
  subroutine setup_system (this)
    ...
    if (this%test_params%get_write_aggr_info()) then
      iounit = io_open(file=this%test_params%get_output_handler_dir_path()//this%test_params%get_prefix()//'_aggr_info.csv',action='write')
      check(iounit>0)
  ...
  subroutine assemble_system (this)
    ...
    class is (sparse_matrix_t)  
       ...
       iounit = io_open(file=this%test_params%get_output_handler_dir_path()//this%test_params%get_prefix()//'_matrix.mm',action='write')
       check(iounit>0)
    ...
    class is (serial_scalar_array_t)  
       if (this%test_params%get_write_matrix()) then
       iounit = io_open(file=this%test_params%get_output_handler_dir_path()//this%test_params%get_prefix()//'_vector.mm',action='write')
       check(iounit>0)
  ...
  subroutine check_solution(this)
    ...
    if (this%test_params%get_write_error_norms()) then
      iounit = io_open(file=this%test_params%get_output_handler_dir_path()//this%test_params%get_prefix()//'_error_norms.csv',action='write')
      check(iounit>0)
...
!  end subroutine check_solution_vector
  ...
  subroutine write_solution(this)
    ...
    if(this%test_params%get_write_solution()) then
        ...
        call vtk_writer%write_to_vtk_file(this%test_params%get_output_handler_dir_path()//this%test_params%get_prefix()//'_boundary_normals.vtu')
        call vtk_writer%free()

        ! Write the unfitted mesh
        call vtk_writer%attach_fitted_faces(this%triangulation)
        call vtk_writer%write_to_vtk_file(this%test_params%get_output_handler_dir_path()//this%test_params%get_prefix()//'_fitted_facets.vtu')
        call vtk_writer%free()

        ! Write the unfitted mesh
        call vtk_writer%attach_facets_quadrature_points(this%fe_space)
        call vtk_writer%write_to_vtk_file(this%test_params%get_output_handler_dir_path()//this%test_params%get_prefix()//'_fitted_normals.vtu')
        call vtk_writer%free()
  ...
  subroutine compute_smallest_vol_fraction(this)
    ...
    if (this%test_params%get_write_aggr_info()) then
      iounit = io_open(file=this%test_params%get_output_handler_dir_path()//this%test_params%get_prefix()//'_min_vol.csv',action='write')
      check(iounit>0)
  ...
  subroutine write_filling_curve(this)
    ...
    if(this%test_params%get_write_solution()) then
      ...
      E_IO = VTK_INI_XML(output_format = 'ascii',&
                              filename = this%test_params%get_output_handler_dir_path()//this%test_params%get_prefix()//'_filling_curve.vtu',&
