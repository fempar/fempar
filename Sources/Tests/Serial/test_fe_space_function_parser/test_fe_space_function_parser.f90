...
# include "debug.i90"
  ...
  if ( triangulation%get_num_dims() == 2) then  
    call source_term_parser%create("-( (6*x*y^3) + (6*x^3*y) )") 
    call boundary_function_parser%create("x^3*y^3")
    call solution_function_parser%create("x^3*y^3")
    call solution_gradient_parser_comp1%create("3*x^2*y^3")
    call solution_gradient_parser_comp2%create("3*x^3*y^2")
    ...
    call source_term_parser%create("-( (6*x*y^3*z^3) + (6*x^3*y*z^3) + (6*x^3*y^3*z) )")
    call boundary_function_parser%create("x^3*y^3*z^3") 
    call solution_function_parser%create("x^3*y^3*z^3") 
    call solution_gradient_parser_comp1%create("3*x^2*y^3*z^3")
    call solution_gradient_parser_comp2%create("3*x^3*y^2*z^3")
    call solution_gradient_parser_comp3%create("3*x^3*y^3*z^2")
    call solution_gradient_parser%create( solution_gradient_parser_comp1, &
                                          solution_gradient_parser_comp2, &
