...
!   type, extends(JP_triangulation_t) :: JP_par_triangulation_t
!      integer(ip)                             :: num_local   = -1    ! number of local elements
!      integer(ip)                             :: num_ghost   = -1    ! number of ghost elements (remote neighbors)
!      type(plain_par_element_topology_set_t) :: element_set
!      class(plain_par_element_topology_iterator_t), allocatable :: local_elements_iterator
!      class(plain_par_element_topology_iterator_t), allocatable :: ghost_elements_iterator
!      class(plain_par_element_topology_iterator_t), allocatable :: boundary_elements_iterator
...
!     implicit none
!     class(JP_par_triangulation_t)                       , intent(in) :: this
...
!     class is(plain_par_element_topology_iterator_t)
...
!   !   class is(plain_JP_par_element_topology_subset_iterator_t)
...
!     !allocate(plain_JP_par_element_topology_set_t :: trian%element_set)
