...
# include "debug.i90"
  ...
  public :: par_precond_dd_diagonal_create, par_precond_dd_diagonal_free, &
            par_precond_dd_diagonal_ass_struct, par_precond_dd_diagonal_fill_val, &
            par_precond_dd_diagonal_apply_all_unk
  ...
  end subroutine par_precond_dd_diagonal_create
  ...
  end subroutine par_precond_dd_diagonal_ass_struct
  ...
  end subroutine par_precond_dd_diagonal_fill_val
  ...
  end subroutine par_precond_dd_diagonal_apply_all_unk
  ...
  end subroutine par_precond_dd_diagonal_free
...
!!$       assert (associated(op%mat))
    ...
    call x%CleanTemp()
  end subroutine par_precond_dd_diagonal_apply_tbp
  ...
  function par_precond_dd_diagonal_apply_fun_tbp (op, x) result(y)
    ...
    call x%CleanTemp()
  end function par_precond_dd_diagonal_apply_fun_tbp
