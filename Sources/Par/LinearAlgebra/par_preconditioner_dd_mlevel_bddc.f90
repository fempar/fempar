...
# include "debug.i90"
  ...
  type, extends(base_operator_t) :: par_preconditioner_dd_mlevel_bddc_t
   ...
   contains
     ...
     procedure :: free_values => par_preconditioner_dd_mlevel_bddc_free_values_tbp
...
!!$       assert (associated(op%mat))
     ...
     !=============================================================================
     subroutine par_preconditioner_dd_mlevel_bddc_fill_values_tbp (op,stage)
       implicit none
       ! Parameters
       ...
       if(op%fill_values_stage==stage_) then
          call par_preconditioner_dd_mlevel_bddc_fill_val ( op )
       end if

     end subroutine par_preconditioner_dd_mlevel_bddc_fill_values_tbp

     !=============================================================================
     subroutine par_preconditioner_dd_mlevel_bddc_free_values_tbp (op,stage)
       implicit none
       ! Parameters
       class(par_preconditioner_dd_mlevel_bddc_t)    , intent(inout) :: op
       integer(ip), optional , intent(in)       :: stage
       ...
       if(op%free_values_stage==stage_) call par_preconditioner_dd_mlevel_bddc_free ( op, free_values )
       
     end subroutine par_preconditioner_dd_mlevel_bddc_free_values_tbp
