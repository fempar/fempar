...
contains
  ...
  subroutine set_mesh_group_lists(this)
    ...
    error = values_group%set(key = number_of_dimensions_key     , value = 2);                         check(error==0)
    error = values_group%set(key = number_of_cells_per_dir_key  , value = [2,2,2]);                   check(error==0)
    ...
    error = values_group%set(key = number_of_levels_key       , value = 1);       check(error==0)
    error = values_group%set(key = number_of_parts_per_dir_key, value = [1,1,0]); check(error==0)
    ...
    error = switches_group%set(key = number_of_dimensions_key     , value = '--dim')                   ; check(error==0)
    error = switches_group%set(key = number_of_cells_per_dir_key  , value = '--number_of_cells')       ; check(error==0)
    ...
    ! Mesh parallelization
    error = switches_group%set(key = number_of_levels_key       , value = '--number_of_levels'); check(error==0)
    error = switches_group%set(key = number_of_parts_per_dir_key, value = '--number_of_parts') ; check(error==0)
    ...
    error = switches_ab_group%set(key = number_of_dimensions_key     , value = '-dm')    ; check(error==0)
    error = switches_ab_group%set(key = number_of_cells_per_dir_key  , value = '-n')     ; check(error==0)
    ...
    ! Mesh parallelization
    error = switches_ab_group%set(key = number_of_levels_key       , value = '-l') ; check(error==0)
    error = switches_ab_group%set(key = number_of_parts_per_dir_key, value = '-np'); check(error==0)
    ...
    error = helpers_group%set(key = number_of_dimensions_key   , value = 'Number of space dimensions')                         ; check(error==0)
    error = helpers_group%set(key = number_of_cells_per_dir_key, value = 'Number of cells per direction')                      ; check(error==0)
    ...
    ! Mesh parallelization
    error = helpers_group%set(key = number_of_levels_key       , value = 'Number of parallel solver coarsening levels'); check(error==0)
    error = helpers_group%set(key = number_of_parts_per_dir_key, value = 'Number of parts per direction and per level'); check(error==0)
    ...
    error = required_group%set(key = number_of_dimensions_key     , value = .false.); check(error==0)
    error = required_group%set(key = number_of_cells_per_dir_key  , value = .false.); check(error==0)
    ...
    ! Mesh parallelization
    error = required_group%set(key = number_of_levels_key       , value = .false.); check(error==0)
    error = required_group%set(key = number_of_parts_per_dir_key, value = .false.); check(error==0)
