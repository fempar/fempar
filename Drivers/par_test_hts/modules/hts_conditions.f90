...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module hts_conditions_names
  use fempar_names

  implicit none
# include "debug.i90"
  private
  type, extends(conditions_t) :: hts_conditions_t
  private
  integer(ip)                       :: num_dims
...
end type hts_conditions_t

public :: hts_conditions_t

contains

subroutine maxwell_conditions_set_num_dims (this, num_dims)
 implicit none
 class(hts_conditions_t), intent(inout) :: this
...
function maxwell_conditions_get_num_components(this)
 implicit none
 class(hts_conditions_t), intent(in) :: this
...
subroutine maxwell_conditions_get_function ( this, boundary_id, component_id, function )
 implicit none
 class(hts_conditions_t), target            , intent(in)  :: this
 integer(ip)                                    , intent(in)  :: boundary_id
...
end module hts_conditions_names
