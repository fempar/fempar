...
contains
  ...
  subroutine hts_nedelec_params_define_parameters(this)
    ...
    ! MESHING parameters 
    error = switches%set(key = num_dimensions_key      , value = '--num_dimensions') ; check(error==0)
    ...
    error = switches_ab%set(key = num_dimensions_key   , value = '-dim')       ; check(error==0)
    ...
    ! MESHING parameters
    error = helpers%set(key = num_dimensions_key   , value = 'Number of dimensions')  ; check(error==0)
