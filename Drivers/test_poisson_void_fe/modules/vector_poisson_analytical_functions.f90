...
module vector_poisson_void_fe_analytical_functions_names
  use fempar_names
...
# include "debug.i90"
  ...
  type vector_poisson_void_fe_analytical_functions_t
     private
     type(source_term_t)         :: source_term
     type(boundary_function_t)   :: boundary_function
     type(solution_function_t)   :: solution_function
   contains
     procedure :: set_num_dimensions    => poisson_void_fe_analytical_functions_set_num_dimensions
     procedure :: get_source_term       => poisson_void_fe_analytical_functions_get_source_term
     procedure :: get_boundary_function   => poisson_void_fe_analytical_functions_get_boundary_function
     procedure :: get_solution_function   => poisson_void_fe_analytical_functions_get_solution_function
  end type vector_poisson_void_fe_analytical_functions_t

  public :: vector_poisson_void_fe_analytical_functions_t, boundary_function_t
...
contains  
  ...
  !===============================================================================================
  subroutine poisson_void_fe_analytical_functions_set_num_dimensions ( this, num_dimensions )
    implicit none
    class(vector_poisson_void_fe_analytical_functions_t), intent(inout)    :: this
    integer(ip), intent(in) ::  num_dimensions
  ...
  end subroutine poisson_void_fe_analytical_functions_set_num_dimensions 
  
  !===============================================================================================
  function poisson_void_fe_analytical_functions_get_source_term ( this )
    implicit none
    class(vector_poisson_void_fe_analytical_functions_t), target, intent(in)    :: this
    class(vector_function_t), pointer :: poisson_void_fe_analytical_functions_get_source_term
    poisson_void_fe_analytical_functions_get_source_term => this%source_term
  end function poisson_void_fe_analytical_functions_get_source_term
  
  !===============================================================================================
  function poisson_void_fe_analytical_functions_get_boundary_function ( this )
    implicit none
    class(vector_poisson_void_fe_analytical_functions_t), target, intent(in)    :: this
    type(boundary_function_t), pointer :: poisson_void_fe_analytical_functions_get_boundary_function
    poisson_void_fe_analytical_functions_get_boundary_function => this%boundary_function
  end function poisson_void_fe_analytical_functions_get_boundary_function
  
  !===============================================================================================
  function poisson_void_fe_analytical_functions_get_solution_function ( this )
    implicit none
    class(vector_poisson_void_fe_analytical_functions_t), target, intent(in)    :: this
    class(vector_function_t), pointer :: poisson_void_fe_analytical_functions_get_solution_function
    poisson_void_fe_analytical_functions_get_solution_function => this%solution_function
  end function poisson_void_fe_analytical_functions_get_solution_function

end module vector_poisson_void_fe_analytical_functions_names
!***************************************************************************************************
