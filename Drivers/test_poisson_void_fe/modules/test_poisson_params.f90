...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module test_poisson_void_fe_params_names
  use fempar_names
# include "debug.i90"
  ...
  type test_poisson_void_fe_params_t  
     private 
     ! IO parameters
   ...
   contains
     procedure, non_overridable             :: create       => test_poisson_void_fe_create
     procedure, non_overridable, private    :: set_default  => test_poisson_void_fe_set_default
     procedure, non_overridable, private    :: add_to_cli   => test_poisson_void_fe_add_to_cli
     procedure, non_overridable             :: parse        => test_poisson_void_fe_parse 
     procedure, non_overridable             :: free         => test_poisson_void_fe_free
  ...
  end type test_poisson_void_fe_params_t  

  ! Types
  public :: test_poisson_void_fe_params_t

contains

  subroutine test_poisson_void_fe_create(this)
    implicit none
    class(test_poisson_void_fe_params_t), intent(inout) :: this
    
    call this%free()
    
     ! Initialize Command Line Interface
    call this%cli%init(progname    = 'test_poisson_void_fe',                                                     &
         &        version     = '',                                                                 &
         &        authors     = '',                                                                 &
         &        license     = '',                                                                 &
         &        description =  'FEMPAR test to solve the 2D poisson_void_fe PDE with known analytical solution. &
                                  Boundary set ID 1 MUST BE ASSIGNED to the whole boundary.', &
         &        examples    = ['test_poisson_void_fe -h  ', 'test_poisson_void_fe -h  ' ])
    
    call this%set_default()
    call this%add_to_cli()
  end subroutine test_poisson_void_fe_create
  
  subroutine test_poisson_void_fe_set_default(this)
    implicit none
    class(test_poisson_void_fe_params_t), intent(inout) :: this
    ! IO parameters
  ...
  end subroutine test_poisson_void_fe_set_default
  
  !==================================================================================================
  subroutine test_poisson_void_fe_add_to_cli(this)
    implicit none
    class(test_poisson_void_fe_params_t) , intent(inout) :: this
    ...
    check(error==0)  
    call this%cli%add(switch='--fe-formulation',switch_ab='-f',help='cG or dG FE formulation for poisson_void_fe problem',&
  ...
  end subroutine test_poisson_void_fe_add_to_cli
  
  subroutine test_poisson_void_fe_parse(this,parameter_list)
    implicit none
    class(test_poisson_void_fe_params_t), intent(inout) :: this
  ...
  end subroutine test_poisson_void_fe_parse  

  subroutine test_poisson_void_fe_free(this)
    implicit none
    class(test_poisson_void_fe_params_t), intent(inout) :: this
    ...
    call this%cli%free()
  end subroutine test_poisson_void_fe_free

  ! GETTERS *****************************************************************************************
  function get_dir_path(this)
    implicit none
    class(test_poisson_void_fe_params_t) , intent(in) :: this
...
end module test_poisson_void_fe_params_names
