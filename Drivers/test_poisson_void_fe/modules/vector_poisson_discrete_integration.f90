...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module vector_poisson_void_fe_discrete_integration_names
  use fempar_names
  
  implicit none
# include "debug.i90"
  private
  type, extends(discrete_integration_t) :: vector_poisson_void_fe_discrete_integration_t
     private
     class(vector_function_t), pointer :: source_term
   contains
     procedure :: set_source_term
     procedure :: integrate
  end type vector_poisson_void_fe_discrete_integration_t
  
  public :: vector_poisson_void_fe_discrete_integration_t
  
contains
   
  subroutine set_source_term (this, vector_function)
    implicit none
    class(vector_poisson_void_fe_discrete_integration_t)        , intent(inout) :: this
  ...
  subroutine integrate ( this, fe_space, matrix_array_assembler )
    implicit none
    class(vector_poisson_void_fe_discrete_integration_t), intent(in)    :: this
...
end module vector_poisson_void_fe_discrete_integration_names
