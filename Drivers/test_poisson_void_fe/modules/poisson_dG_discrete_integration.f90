...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module poisson_void_fe_dG_discrete_integration_names
  use fempar_names
...
# include "debug.i90"
  private
  type, extends(discrete_integration_t) :: poisson_void_fe_dG_discrete_integration_t
     type(poisson_void_fe_analytical_functions_t), pointer :: analytical_functions => NULL()
     type(poisson_void_fe_conditions_t)          , pointer :: poisson_void_fe_conditions   => NULL()
   contains
     procedure :: set_analytical_functions
     procedure :: set_poisson_void_fe_conditions
     procedure :: integrate
  end type poisson_void_fe_dG_discrete_integration_t
  
  public :: poisson_void_fe_dG_discrete_integration_t
  
contains

  subroutine set_analytical_functions ( this, analytical_functions )
     implicit none
     class(poisson_void_fe_dG_discrete_integration_t)        , intent(inout) :: this
     type(poisson_void_fe_analytical_functions_t)    , target, intent(in)    :: analytical_functions
     this%analytical_functions => analytical_functions
  end subroutine set_analytical_functions
  
  subroutine set_poisson_void_fe_conditions ( this, poisson_void_fe_conditions )
     implicit none
     class(poisson_void_fe_dG_discrete_integration_t)        , intent(inout) :: this
     type(poisson_void_fe_conditions_t)              , target, intent(in)    :: poisson_void_fe_conditions
     this%poisson_void_fe_conditions => poisson_void_fe_conditions
  end subroutine set_poisson_void_fe_conditions
  
  
  subroutine integrate ( this, fe_space, matrix_array_assembler )
    implicit none
    class(poisson_void_fe_dG_discrete_integration_t), intent(in)    :: this
    ...
    call this%poisson_void_fe_conditions%get_function(1,1,boundary_function)
...
end module poisson_void_fe_dG_discrete_integration_names
