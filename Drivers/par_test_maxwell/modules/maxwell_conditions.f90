...
contains
  procedure :: set_num_dimensions          => maxwell_conditions_set_num_dimensions
  ...
  procedure :: get_number_components       => maxwell_conditions_get_number_components  
...
subroutine maxwell_conditions_set_num_dimensions (this, num_dimensions)
 implicit none
 class(maxwell_conditions_t), intent(inout) :: this
 integer(ip)                           , intent(in)    :: num_dimensions
 this%num_dimensions = num_dimensions
end subroutine maxwell_conditions_set_num_dimensions

subroutine maxwell_conditions_set_boundary_function_Hx (this, scalar_function)
 implicit none
 class(maxwell_conditions_t), intent(inout)      :: this
...
subroutine maxwell_conditions_set_boundary_function_Hy (this, scalar_function)
 implicit none
 class(maxwell_conditions_t), intent(inout)      :: this
 class(scalar_function_t)           , target, intent(in) :: scalar_function
...
subroutine maxwell_conditions_set_boundary_function_Hz (this, scalar_function)
 implicit none
 class(maxwell_conditions_t), intent(inout)      :: this
 class(scalar_function_t)           , target, intent(in) :: scalar_function
...
function maxwell_conditions_get_number_components(this)
 implicit none
 class(maxwell_conditions_t), intent(in) :: this
 integer(ip) :: maxwell_conditions_get_number_components
 assert ( this%num_dimensions == 2 .or. this%num_dimensions == 3 ) 
 maxwell_conditions_get_number_components = this%num_dimensions
end function maxwell_conditions_get_number_components
