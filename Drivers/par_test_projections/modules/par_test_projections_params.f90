module par_test_projections_params_names
  use fempar_names
...
#include "debug.i90" 
  ...
  type, extends(parameter_handler_t) :: par_test_projections_params_t
     private
     contains
       procedure :: define_parameters  => par_test_projections_params_define_parameters
  ...
  end type par_test_projections_params_t

  ! Types
  public :: par_test_projections_params_t

contains

  !==================================================================================================
  subroutine par_test_projections_params_define_parameters(this)
    implicit none
    class(par_test_projections_params_t), intent(inout) :: this
  ...
  end subroutine par_test_projections_params_define_parameters

  ! GETTERS *****************************************************************************************
  function get_dir_path(this)
    implicit none
    class(par_test_projections_params_t) , intent(in) :: this
...
end module par_test_projections_params_names
