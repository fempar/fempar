...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module par_test_projections_driver_names
  use fempar_names
...
# include "debug.i90"
  ...
  type par_test_projections_driver_t 
     private 
     
     ! Place-holder for parameter-value set provided through command-line interface
     type(par_test_projections_params_t)  :: test_params
  ...
  end type par_test_projections_driver_t

  ! Types
  public :: par_test_projections_driver_t
...
!========================================================================================
  ...
  subroutine setup_coarse_fe_handlers(this)
    implicit none
    class(par_test_projections_driver_t), target, intent(inout) :: this
   	integer(ip) :: istat, i 
  ...
  subroutine setup_fe_space(this)
    ...
    call this%fe_space%set_up_facet_integration()   
				...
				! Need to create for block_layout setup although it won't be used in this driver 
  ...
  subroutine project_analytical_functions (this)
    implicit none
    class(par_test_projections_driver_t), intent(inout) :: this
 ...
 call this%problem_functions%set_num_dims(this%triangulation%get_num_dims())
  ...
  subroutine write_solution(this)
    implicit none
    class(par_test_projections_driver_t), intent(in)    :: this
...
end module par_test_projections_driver_names
