...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module par_nsi_discrete_integration_names
  use fempar_names
...
# include "debug.i90"
  ...
  type, extends(discrete_integration_t), abstract :: par_nsi_discrete_integration_t
     private
   ...
   contains
     ...
     procedure :: free => par_nsi_discrete_integration_free
  end type par_nsi_discrete_integration_t

  abstract interface
     subroutine  create_interface(this,number_dimensions,analytical_functions)
       import :: par_nsi_discrete_integration_t, par_nsi_analytical_functions_t, ip
       implicit none
       class(par_nsi_discrete_integration_t)       , intent(inout) :: this
     ...
     function is_symmetric_interface(this)
       import :: par_nsi_discrete_integration_t
       implicit none
       class(par_nsi_discrete_integration_t)       , intent(inout) :: this
     ...
     subroutine init_solution_interface(this,fe_space,solution)
       import :: par_nsi_discrete_integration_t, serial_fe_space_t, fe_function_t
       class(par_nsi_discrete_integration_t)       , intent(inout) :: this
     ...
     !  import :: par_nsi_discrete_integration_t, serial_fe_space_t
     !  class(par_nsi_discrete_integration_t)       , intent(inout) :: this
     !  class(serial_fe_space_t)                      , intent(in)    :: fe_space
  ...
  type, extends(par_nsi_discrete_integration_t) :: irreducible_discrete_integration_t
     private
   contains
  ...
  type, extends(par_nsi_discrete_integration_t) :: nsi_discrete_integration_t
     private
   contains
  ...
  public :: par_nsi_discrete_integration_t, irreducible_discrete_integration_t, nsi_discrete_integration_t
  public :: discrete_integration_type_irreducible, discrete_integration_type_mixed_u_p
  
contains

  subroutine par_nsi_discrete_integration_free ( this )
     implicit none
     class(par_nsi_discrete_integration_t)   ,intent(inout)  :: this
     integer(ip) :: istat
  ...
  end subroutine par_nsi_discrete_integration_free
  ...
  function get_fe_function (this)
    implicit none
    class(par_nsi_discrete_integration_t), target, intent(in) :: this
...
!==============================================================================
  ...
  function get_number_fields(this)
    implicit none
    class(par_nsi_discrete_integration_t), intent(in)   :: this
...
end module par_nsi_discrete_integration_names
