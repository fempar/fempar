...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module par_nsi_nonlinear_solver_names
  use fempar_names
...
# include "debug.i90"
  ...
  character(len=*), parameter :: par_nsi_abs_res_norm                  = 'abs_res_norm'                  ! |r(x_i)| <= abs_tol
  character(len=*), parameter :: par_nsi_rel_inc_norm                  = 'rel_inc_norm'                  ! |dx_i|   <= rel_norm*|x_i|
  character(len=*), parameter :: par_nsi_rel_r0_res_norm               = 'rel_r0_res_norm'               ! |r(x_i)| <= rel_tol*|r(x_0)|
  character(len=*), parameter :: par_nsi_abs_res_norm_and_rel_inc_norm = 'abs_res_norm_and_rel_inc_norm' ! |r(x_i)| <= abs_tol & |dx_i| <= rel_norm*|x_i|
  ...
  public :: par_nsi_abs_res_norm
  public :: par_nsi_rel_inc_norm
  public :: par_nsi_rel_r0_res_norm
  public :: par_nsi_abs_res_norm_and_rel_inc_norm
...
end module par_nsi_nonlinear_solver_names
