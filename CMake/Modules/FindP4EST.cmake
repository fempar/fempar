...
SET(${LIB_PREFIX}_SC_LIB_NAME sc)
SET(${LIB_PREFIX}_INC_FILENAME p4est.h sc.h)
...
MESSAGE("P4EST_INCLUDES:" ${${LIB_PREFIX}_INCLUDES})
MESSAGE("P4EST_LIBS:" ${${LIB_PREFIX}_LIBS})

IF(${LIB_PREFIX}_LIBS)
    # DEPENDE DE libsc
    FIND_LIBRARY(${LIB_PREFIX}_SC_LIBS
        NAMES ${${LIB_PREFIX}_SC_LIB_NAME}
        PATHS ${DEFAULT_LIB_PATHS}  ENV LD_LIBRARY_PATH
        PATH_SUFFIXES ${${LIB_PREFIX}_LIB_SUFFIXES}
        DOC "The path to ${LIB_PREFIX} library"
    )

    IF(${LIB_PREFIX}_SC_LIBS)
        SET(${LIB_PREFIX}_INCLUDE_DIR ${${LIB_PREFIX}_INCLUDES} ${${LIB_PREFIX}_SC_INCLUDES})
        SET(${LIB_PREFIX}_LIBRARIES ${${LIB_PREFIX}_LIBS} ${${LIB_PREFIX}_SC_LIBS})
