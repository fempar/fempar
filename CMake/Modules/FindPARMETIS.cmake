...
SET(LIB_PREFIX PARMETIS)
SET(${LIB_PREFIX}_LIB_NAME parmetis)
SET(${LIB_PREFIX}_INC_FILENAME parmetis.h)
SET(${LIB_PREFIX}_INC_SUFFIXES "include" "libparmetis" "include/parmetis")
SET(${LIB_PREFIX}_LIB_SUFFIXES "lib" "libparmetis" "lib/parmetis" "lib/${CMAKE_LIBRARY_ARCHITECTURE}" "${CMAKE_LIBRARY_ARCHITECTURE}")
...
FIND_LIBRARY(${LIB_PREFIX}_LIBS
    ...
    PATHS ${DEFAULT_INC_PATHS} ENV PATH LD_LIBRARY_PATH
