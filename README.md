...
In the meantime, you may take a look at the **Dockerfile recipes** ([1](https://gitlab.com/fempar/fempar/blob/experimental/Containers/Docker/gnu/Dockerfile), [2](https://gitlab.com/fempar/fempar/blob/experimental/Containers/Docker/gnu/debug/Dockerfile), [3](https://gitlab.com/fempar/fempar/blob/experimental/Containers/Docker/gnu/debug/p4est_serial/Dockerfile)) which are used to create the `fempar/fempar-env:gnu_debug_p4est_serial` Docker image above in order to grasp how you may compile FEMPAR's dependencies on your Desktop/Laptop or HPC infrastructure.
